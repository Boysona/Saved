...
bot.set_my_description(
    description="transcribe voice messages, audio files, video files, for free
...
def send_subscription_message(chat_id):
    ...
    bot.send_message(
        chat_id,
        """🚫 𝗡𝗼 𝘀𝘂𝗯𝘀𝗰𝗿𝗶𝗽𝘁𝗶𝗼𝗻𝘀, 𝗻𝗼 𝗺𝗼𝗻𝘁𝗵𝗹𝘆 𝗳𝗲𝗲𝘀!
✨ 𝗝𝘂𝘀𝘁 𝗷𝗼𝗶𝗻 @mediatranscriber 𝘁𝗼 𝘂𝗻𝗹𝗼𝗰𝗸 𝗳𝘂𝗹𝗹 𝗮𝗰𝗰𝗲𝘀𝘀
🤖 𝗧𝗵𝗲𝗻 𝗲𝗻𝗷𝗼𝘆 𝘁𝗵𝗲 𝗯𝗼𝘁 𝘂𝗻𝗹𝗶𝗺𝗶𝘁𝗲𝗱 & 𝗳𝗿𝗲𝗲!
‼️ 𝗔𝗳𝘁𝗲𝗿 𝗷𝗼𝗶𝗻𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗵𝗮𝗻𝗻𝗲𝗹, 𝗰𝗼𝗺𝗲 𝗯𝗮𝗰𝗸 𝗮𝗻𝗱 𝘀𝘁𝗮𝗿𝘁 𝘂𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗼𝘁!""",
        reply_markup=markup
    )
