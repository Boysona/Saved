...
# **Halkan waxaan ku daray threaded=True si uu bot-ku u wado multithreading**
...
def set_bot_info():
    commands = [
        ...
        telebot.types.BotCommand("status", "statistics"),
        telebot.types.BotCommand("info", "instructions"),
        telebot.types.BotCommand("translate", "Translate"),
        telebot.types.BotCommand("summarize", "Summarize"),
    ]
...
def callback_download_tiktok(call):
    ...
    # --------- Halkan ayaan ka saarnay 'typing' action-ka ---------
    # bot.send_chat_action(call.message.chat.id, 'typing')

    # beddelidda: si uusan u muujin "typing", u muuji "upload_video" si chat section-ku u noqdo uploading
    ...
    try:
        ...
        # Marka file-ka diyaarsan yahay, fariin upload video la socota
