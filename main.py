...
def button_translate_handler(call):
    ...
    prompt_msg = bot.send_message(
        call.message.chat.id,
        "Send me the name of the language you want to translate into (e.g. Spanish, Arabic):"
    )
...
def button_summarize_handler(call):
    ...
    prompt_msg = bot.send_message(
        call.message.chat.id,
        "Send me the name of the language you want the summary in (e.g. English):"
    )
...
def handle_translate(message):
    ...
    prompt_msg = bot.send_message(
        message.chat.id,
        "Send me name of the language you want the text to be translated into (e.g. Spanish, Arabic):"
    )
    bot.register_next_step_handler(prompt_msg, lambda resp: do_translate(resp, uid))
...
def handle_summarize(message):
    ...
    prompt_msg = bot.send_message(
        message.chat.id,
        "Send me name of the language you want the text to be summary into (e.g. English):"
    )
    bot.register_next_step_handler(prompt_msg, lambda resp: do_summarize(resp, uid))
